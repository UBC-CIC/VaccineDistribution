...
class CreateBatchModal extends React.Component {
  ...
  handleSubmit = event => {
    ...
    const formNotCompleted = PersonId.length===0||ProductId.length===0||BatchNo.length===0||UnitsProduced.length===0||
              UnitsRemaining.length===0||MfgDate.length===0
    return (
        ...
        <Form onSubmit={this.handleSubmit}>
          ...
          <FormGroup>
            ...
            <Input
              ...
              type="text"
              name="UnitsProduced"
              value={this.state.UnitsProduced}
              onChange={this.handleOnChange}
            />
          </FormGroup>
          ...
          <FormGroup>
            <label
              className="form-control-label"
              htmlFor="UnitsRemaining_id"
            >
              Units Remaining
            </label>
            <Input
              id="UnitsRemaining_id"
              type="text"
              name="UnitsRemaining"
              value={this.state.UnitsRemaining}
              onChange={this.handleOnChange}
            />
          </FormGroup>
