...
class ApprovalJoinRequestEntityTable extends Component {
     ...
     renderBody = () => {
         ...
         return filterEntity.map(({
                                      JoiningRequestNumber,
                                      SenderEmployeeId,
                                      SenderPersonId,
                                      ScEntityId,
                                      isAccepted,
             ...
             return (
                 <tr key={SenderEmployeeId}>
                     ...
                     <td className='operation'>
                         <button className='buttonApproval'
                                 onClick={this.props.approveEntityData.bind(this, JoiningRequestId, SenderPersonId)}>Approve
                         </button>
                         <button className='buttonDeny'
                                 onClick={this.props.denyEntityData.bind(this, JoiningRequestId, SenderPersonId)}>Deny
                         </button>
                    </td>
                </tr>
            )
